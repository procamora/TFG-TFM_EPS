...
% Información de capítulo en cabecera e interno
% headmark solo se imprime 1 vez, con el consigo que no salga en los capitulos
%\ihead[{\color{gray30}\scshape\small\headmark}]{{\color{gray30}\scshape\small\leftmark}}
% Número de página en pie de página y externo. Usar cfoot para centrar
%\ifoot[\normalfont\pagemark]{\normalfont\pagemark}
