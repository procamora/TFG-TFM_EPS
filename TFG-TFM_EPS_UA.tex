...
\begin{document}
	...
	\thispagestyle{empty}  % Borra la cabecera por haberla creado mal :)
	\tableofcontents \thispagestyle{empty}	     	% Índice
	\listoffigures	\thispagestyle{empty}	     	% Índice de figuras
	\listoftables	\thispagestyle{empty}	     	% Índice de tablas
	\lstlistoflistings \thispagestyle{empty}	    % Índice de códigos
